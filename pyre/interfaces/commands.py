"""Command interface definitions for the UI command pattern."""
...
class CommandStatus(enum.IntEnum):
    ...
    Active = 0  # The command is in progress and can still receive user input
    Inactive = 1  # The command is no longer receiving input, but has not completed
