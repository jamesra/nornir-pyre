...
from pyre.ui import imagetransformpanelbase
...
class ImageTransformPanelConfig:
    ...
    view_type: pyre.state.ViewType  # Type of view to display
    imagename_space_mapping: dict[str, pyre.state.Space]  # Maps an image name to a space
...
class ImageTransformViewPanel(imagetransformpanelbase.ImageTransformPanelBase):
    ...
    def on_imageviewmodelmanager_change(self,
        ...
        print(
            f'* ImageTransformViewPanel.on_imageviewmodelmanager_change {name} {action.value} self: {self._config.imagename_space_mapping}')
        if name not in self._config.imagename_space_mapping:
    ...
    def _handle_add_imageviewmodel_event(self, name: str, image: pyre.viewmodels.ImageViewModel):
        ...
        if self.config.view_type == pyre.state.ViewType.Composite: 
            ...
            self._image_transform_view = ImageTransformView(space=self.space,
                                                            ...
                                                            transform_controller=self._config.transform_controller)
            print(f'Added image view model {name} to {self.config.view_type.value} view')
